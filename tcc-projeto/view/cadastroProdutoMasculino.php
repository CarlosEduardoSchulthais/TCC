...
<head>
    ...
    <title>Cadastro de Produto Masculino</title>
...
<body style="margin: 0;
    ...
    <div class="cadastroFundo">
        <form method="post" name="formCadProduto" action="../control/cadProdutoMasculino.php" enctype="multipart/form-data">
            <input type="hidden" name="idProduto" value="<?php echo $idProduto; ?>">
            <div class="cadastro">
                <div class="row" style="display: flex; justify-content: space-around">
                    <p class="h1" style="text-align: center; font-family: Impact, Haettenschweile, 'Arial Narrow Bold', sans-serif;"><?php if(isset($_GET["id"])){ echo "Alterar Produto Masculino"; } else{ echo "Cadastro de Produto Masculino"; } ?></p>
                </div>
                <div class="mensagem">
                    <?php
                        if(isset($_GET["msg"])){
