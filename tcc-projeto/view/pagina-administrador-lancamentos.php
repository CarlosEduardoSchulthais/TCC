...
<body style="margin: 0;
    ...
    <div class="cadastroFundo" style="background-color: white;">
        <div class="row" style="display: flex; justify-content: center">
            <div class="col">
                <p class="h1" style="text-align: center; font-family: Impact, Haettenschweile, 'Arial Narrow Bold', sans-serif;">Lançamentos</p>
            </div>
        </div>
        <br>
        <br>
        ...
        <?php
            ...
            $resultado = exibirProdutosLancamento();
            while ( $registro = mysqli_fetch_assoc($resultado) ) {
                ...
                echo "<a href='cadastroProdutoFeminino.php?id=$idProduto' style='text-align: center; margin: 0 10px'><img src='../img/editar.png' height='30' width='30'></a>"; 
